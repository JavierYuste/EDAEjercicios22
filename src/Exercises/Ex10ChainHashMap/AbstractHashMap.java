...
public abstract class AbstractHashMap <K,V> extends AbstractMap<K,V> {
    ...
    public boolean containsKey(K key) {
        // TODO: obtener el hash de la clave (key) y comprobar si existe en el bucket apropiado
    ...
    private int hashValue(K key) {
        // TODO: obtener el hash de la clave (key.hashCode())
        //  y normalizarlo utilizando la estrategia MAD (Multiply, Add, Divide).
        //  Recuerda que el valor hash puede ser negativo, asi que es buena idea obtener su valor absoluto (Math.abs())
        // MAD strategy:
        //     h(key) = ((ay + b) mod p) mod N
        //         - y: key
        //         - a: this.scale
        //         - b: this.shift
        //         - p: this.prime
